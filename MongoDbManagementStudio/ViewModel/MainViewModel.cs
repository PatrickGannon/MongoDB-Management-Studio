...
namespace MongoDBManagementStudio.ViewModel
{
    ...
    {
        private IMongoQueryFactory _queryFactory;
        ...
        [ImportMany]
        IEnumerable<Lazy<IMongoQueryFactory, IDriverMetadata>> MongoQueryFactories { get; set; }

        private IMongoQueryFactory MongoQueryFactory
        {
            get
            {
                if (_queryFactory == null)
                {
                    _queryFactory = (from q in MongoQueryFactories
        ...
        public MainViewModel(IMongoQueryFactory queryFactory) : this()
        {
        ...
        {
            IMongoQuery mongoQuery = MongoQueryFactory.BuildQuery();
        ...
        private void ShowCollections()
        {
            ...
            IMongoQuery query = MongoQueryFactory.BuildQuery();
